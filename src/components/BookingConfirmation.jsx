    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-teal-50">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500">Booking ID: #BKM-88291</p>
        </div>
...
/>
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-1">Alex 'The Blade' Rivera</h3>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">Tuesday, Oct 24th • 2:00 PM</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-teal-mint" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-700">123 Urban Style Ave, Downtown Metro</span>
                </div>
              </div>
