...
{selectedPlan === 'ROYALE' && (
  ...
  {service.rating ?? 0} ({service.reviewCount ?? 0})
                      ...
                      <div className="text-right">
                        ...
                        ) : service.barber?.isAvailable === false ? (
                          <span className="px-6 py-2 bg-teal-mint text-white rounded-lg opacity-60 cursor-not-allowed inline-flex items-center gap-2">
                                    <svg
                                      className="w-4 h-4"
                                      fill="none"
                                      stroke="currentColor"
